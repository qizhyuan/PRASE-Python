...
def test(base, iteration=30):
    ...
    ent_links_path = os.path.join(save_path, "alignment_results_12")
    kgs.reset_ent_align_prob(lambda x: 0.15 * x)
    kgs.load_ent_links(ent_links_path, init_value=0.15, num=20000)
